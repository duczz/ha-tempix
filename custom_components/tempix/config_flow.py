        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional("sec_temperature_tweaks"): section(vol.Schema({
                    ...
                    vol.Optional(CONF_ENABLE_TEMPORARY_MANUAL_OVERRIDE, default=self._get_default(CONF_ENABLE_TEMPORARY_MANUAL_OVERRIDE, True)): _bool_sel(),
                ...
                vol.Optional("sec_away_mode"): section(vol.Schema({
                    vol.Optional(CONF_AWAY_BEHAVIOR, default=self._get_default(CONF_AWAY_BEHAVIOR, AWAY_BEHAVIOR_IGNORE)): _select_sel([AWAY_BEHAVIOR_OFFSET, AWAY_BEHAVIOR_ECO, AWAY_BEHAVIOR_OFF, AWAY_BEHAVIOR_IGNORE], translation_key="away_behavior", mode=selector.SelectSelectorMode.DROPDOWN),
